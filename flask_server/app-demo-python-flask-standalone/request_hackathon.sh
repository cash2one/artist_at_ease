#curl cp01-daiwk-docker-test1.epc.baidu.com:8888 -d '{"userid":111, "word_list": ["øß∑»Õı◊”“ª∫≈µÍ", "…®√ËÃΩ’Îœ‘Œ¢æµ"]}'
#curl http://artist-at-ease_0-0-0-1.jpaas-idea.baidu.com/ -d '{"userid":111, "word_list": ["øß∑»Õı◊”“ª∫≈µÍ", "…®√ËÃΩ’Îœ‘Œ¢æµ"]}'
